...
# Toggle for flattening YOMITOKU JSON into text for the LLM.
# Disabled by default to preserve original structure; set True to revert to prior behavior.
FLATTEN_YOMITOKU_JSON = False
